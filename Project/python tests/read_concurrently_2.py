...
organisms = ['Schistocerca gregaria', 'Bunaea alcinoe', 'Tetrapedia diversipes', 'Pamphilius']	
with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
	sets = [organisms, organisms, organisms]
	executor.map(run_set, sets)
